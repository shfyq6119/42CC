...
/*   Updated: 2024/07/04 05:29:37 by mm-isa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				*ft_strmapi(char const *give, char (*fn)(unsigned int,
							char));
int					ft_strncmp(const char *s1, const char *s2, size_t i);
char				*ft_strnstr(const char *big, const char *smol,
						size_t schlong);
...
t_list				*ft_lstmap(t_list *list, void *(*fn)(void *),
						void (*del)(void *));
